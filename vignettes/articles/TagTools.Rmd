...
```{r, echo = FALSE, eval = TRUE}
library(tagtools)
#if you want to run this example, download the "cats_test_raw.nc" file from https://github.com/animaltags/tagtools_data and change the file path to match where you've saved the files
...
```{r, echo = FALSE, eval = TRUE}
#if you want to run this example, download the "rawtestset3.nc" file from https://github.com/animaltags/tagtools_data and change the file path to match where you've saved the files
...
```{r, echo = FALSE, eval = TRUE}
#if you want to run this example, download the "testset5.nc" file from https://github.com/animaltags/tagtools_data and change the file path to match where you've saved the files
...
```{r, echo = FALSE, eval = TRUE}
#if you want to run this example, download the "testset1.nc" file from https://github.com/animaltags/tagtools_data and change the file path to match where you've saved the files
...
```{r, echo = FALSE, eval = TRUE}
#if you want to run this example, download the "mn12_186a_raw.nc" file from https://github.com/animaltags/tagtools_data and change the file path to match where you've saved the files
...
plot_panels <- plott(X = list(Pcmf = Pcmf$p), 
                     r = TRUE,
                     draw = FALSE)
# we only have 1 plot panel, the depth data
plot_panels[[1]] +
...
```{r, echo = FALSE, eval = TRUE}
#if you want to run this example, download the "zc11_267a.nc" file from https://github.com/animaltags/tagtools_data and change the file path to match where you've saved the files
...
```{r, echo = FALSE, eval = TRUE}
#if you want to run this example, download the "nessie.nc" file from https://github.com/animaltags/tagtools_data and change the file path to match where you've saved the files
...
RTR <- rotation_test(event_times = dt$start, 
                     exp_period = noon, 
                     full_period = c(0,length(nessie$P$data)/nessie$P$sampling_rate), 
                     n_rot = 10000, 
                     ts_fun = length)
print(RTR)
```
...
ZC_file_path <- "nc_files/zc11_267a.nc"
zc <- load_nc(ZC_file_path)
plott(X = list(Depth = zc$P$data, Accel = zc$A$data), 
      fsx = zc$P$sampling_rate, 
      interactive = FALSE)
```
