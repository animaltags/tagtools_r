...
## Data quality checks
For this practical we will use data from a tag attached to the back of a sperm whale. If you want to run this example, download the "rawtestset3.nc" file from https://github.com/animaltags/tagtools_data and change the file path to match where you've saved the files  
