...
# Calibration
	Due to the nature of the tags in use, some calibration must be carried out on the data collected to ensure accuracy of calculations. This varies between cropping data to high activity sections, and fixing offset 
...
# Sound processing 
	The package also undertakes some sound processing by way of measuring spectrum levels, plotting spectrograms and obtaining audio in the form of wav files. 
