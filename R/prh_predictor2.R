...
#' @param interactive logical; run the interactive graphic interface that allows the user to adjust the time windows used for PRH estimation? Default: TRUE
...
prh_predictor2 <- function(P, A, 
  ...
  if (!interactive){
    ...
    # Run the interactive part of fig. 1
...
} # end of prh_predictor2 function