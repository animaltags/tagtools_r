...
#' @param x A vector or matrix of values to display on the horizontal axis.
#' @param y A vector or matrix of values to display on the vertical axis.
#' @param color A vector or matrix of values representing the colour to draw at each point.
